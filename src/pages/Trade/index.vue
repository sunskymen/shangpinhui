  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix">
        <span class="username" :class="{ selected: isShow == 0 }" @click="isShow = 0">在线支付</span>
        <span class="username" style="margin-left:5px;" @click="isShow = 1"
          :class="{ selected: isShow == 1 }">货到付款</span>
